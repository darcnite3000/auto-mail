...
export function tag(id = 'div', props = {}, content = [], attrs = {}) {
  const {
    className = '', style = ''
  } = props
  switch (id.toLowerCase()) {
    ...
    case 'text':
      return text(props, content, attrs)
    case 'img':
...
export function td(props, content, attrs = {}) {
  attrs.valign = attrs.valign || 'top'
  return tag('td', props, content, attrs)
}

export function p(props, content, attrs = {}) {
  return tag('p', props, content, attrs)
}

export function span(props, content, attrs = {}) {
  return tag('span', props, content, attrs)
}

export function strong(props, content, attrs = {}) {
...
export function rows(props = {}, content, attrs) {
...
export function dwRows(props = {}, content, attrs) {
  if (arguments.length === 1) {
    return table({
...
export function columns(props = {}, content, attrs) {
  if (arguments.length === 1) {
    return table({
        columns: true
      },
...
export function dwColumns(props = {}, content, attrs) {
  if (arguments.length === 1) {
    return table({
        className: 'deviceWidth',
        columns: true
...
export function div(props, content, attrs) {
...
export function text(props, content, attrs) {
  if (arguments.length === 1) {
  ...
  return divWrap(props, attrs)(staticContent(content))
}
...
export function paddedCellText({
  ...
  if (innerProps || innerAttrs)
    return td({
      ...
      text(innerProps, content, innerAttrs),
      attrs
    )
  return td({
      style
...
export function dwImg(props = {}, content, attrs) {
  props.className = props.className != undefined ? props.className : 'deviceWidth'
  return img(props, content, attrs)
}
